...
from ..views import IndexView, ShinyAppListView, ShinyAppView
...
class AuthURLTestCase(BaseMixin, TestCase):
    ...
    def test_anonymous_user(self):
        ...
        response = client.get("/auth/", HTTP_X_ORIGINAL_URI="/shiny-4.5/002-text/")
    ...
    def test_user(self):
        ...
        response = client.get("/auth/", HTTP_X_ORIGINAL_URI="/shiny-4.5/001-hello/")
        self.assertEqual(response.status_code, 403)
...
class GroupAccessTestCase(BaseMixin, TestCase):
    ...
    def test_group_member_can_access(self):
        ...
        response = self.client.get(reverse("shinyapp", kwargs={"slug": "students-app"}))
        self.assertEqual(response.status_code, 200)
    ...
    def test_auth_endpoint_for_group_member(self):
        ...
        response = client.get("/auth/", HTTP_X_ORIGINAL_URI="/shiny-4.5/students-app/")
        self.assertEqual(response.status_code, 200)
